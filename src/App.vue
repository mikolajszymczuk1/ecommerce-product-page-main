            ...
            <section class="product-details">
                ...
                <div class="product-details__prices-container">
                    <div class="product-details__prices-wrapper">
                        <div class="product-details__discount-price">${{ discountPrice(product).toFixed(2) }}</div>
                ...
                <div class="product-details__buttons-wrapper">
                    <QuantityCounter @counter-change="changeProductCount" />

                    <!-- Add to cart button -->
                    <button class="product-details__add-to-cart-button"
                        @click="addItemToCart({ product, count })"
                    >
